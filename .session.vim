...
nmap ,d :w!:call JumpToTag()
map ,l :call LoF()
map ,H "fyiw:tabe ~/.viminfo:help f:only
map ,h :call OpenHelp()
vmap ,w "fy:!firefox --new-window f
nmap ,w "fyiW:!firefox --new-window f
...
silent! normal! zE
let &fdl = &fdl
let s:l = 54 - ((17 * winheight(0) + 17) / 35)
...
normal! 021|
tabnext
edit english-lia/grabber-lia-bridge.js
argglobal
balt english-lia/grabber-lia-bridge.js
...
normal! 026|
tabnext
edit english-lia/grabber/youtube/youtube.js
argglobal
balt english-lia/grabber/main.js
iabbr <buffer> par @param {<-->} <++> - <++>
iabbr <buffer> imp import {<-->}  from './<++>';
...
silent! normal! zE
let &fdl = &fdl
let s:l = 43 - ((19 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 43
...
badd +0 english-lia/grabber-lia-bridge.js
badd +0 english-lia/grabber/grabber-offline.md
badd +7 english-lia/grabber/youtube/youtube.js
