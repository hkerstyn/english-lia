...
nnoremap <buffer> <silent> ü :call nerdtree#ui_glue#invokeKeyMap("ü")
...
tabnext
edit english-lia/grabber/default-config.js
argglobal
balt english-lia/grabber/default-config.js
let s:cpo_save=&cpo
set cpo&vim
...
normal! 024|
tabnext
edit english-lia/grabber/container/layout.js
argglobal
balt english-lia/grabber/container/layout.js
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <silent> <Plug>(jsdoc) :call jsdoc#insert()
iabbr <buffer> imp import {<-->}  from './<++>';
...
silent! normal! zE
let &fdl = &fdl
let s:l = 67 - ((20 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 67
...
tabnext 3
set stal=1
badd +28 english-lia/grabber/grabber-offline.md
badd +4 english-lia/grabber/container/dummy.js
badd +0 english-lia/grabber/container/layout.js
badd +0 english-lia/grabber/default-config.js
