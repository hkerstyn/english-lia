...
import{gen, genRaw} from './lul-base.js';
...
export function genTable(cells, heads)
{
  ...
  addCells(table, heads, "TH", "lul-dark");

  if(cells != null && cells != undefined && cells.length > 0)
  addCells(table , cells, "TD", "lul-light");
...
function genHeads(columnCount) {return genElements(1, columnCount, "Kopf");}
function genCells(rowCount, columnCount) {return genElements(rowCount, columnCount, "Zelle");}
